...
RegisterNetEvent("np-wheelfitment_cl:forceMenuOpen")
AddEventHandler("np-wheelfitment_cl:forceMenuOpen", function(data)
    local slider_wWidth = {}
    local slider_wfFL = {}
    local slider_wfFR = {}
    local slider_wfRL = {}
...
RegisterCommand("enterfitment", function()
    TriggerEvent("np-wheelfitment_cl:forceMenuOpen")
end)
